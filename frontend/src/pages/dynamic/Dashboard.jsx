            ...
            <div className="compare-table-container">
                <div className="user-profile-card" style={{ color: 'var(--text-color)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '40px' }}>
                        ...
                        <div style={statCard}>
                            <h4 style={{ color: 'var(--accent-color)', margin: '0 0 10px 0' }}>Email</h4>
                            <p style={{ fontSize: '1rem', fontWeight: '600', margin: 0 }}>{profile?.email}</p>
                        </div>
                    ...
                    <div style={{ marginBottom: '40px', borderBottom: '1px solid rgba(128,128,128,0.2)', paddingBottom: '30px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                            ...
                            <Link to="/saved-cars" className="auth-btn"
                                  style={{ textDecoration: 'none', padding: '10px 20px', background: 'transparent', border: '1px solid var(--accent-color)', color: 'var(--accent-color)' }}>
                                Saved Cars
                            </Link>

                            <Link to="/inventory" className="auth-btn"
                                  style={{ textDecoration: 'none', padding: '10px 20px', background: 'transparent', border: '1px solid var(--accent-color)', color: 'var(--accent-color)' }}>
                                Browse Cars
                            </Link>
                            ...
                            {profile?.role === 'admin' && (
                                <Link to="/admin" className="auth-btn"
                                      style={{ textDecoration: 'none', padding: '10px 20px', background: 'var(--accent-color)' }}>
                                    Admin Panel
                                </Link>
                            )}
